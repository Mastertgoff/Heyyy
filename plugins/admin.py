...
from info import BOT_START_TIME, ADMINS, API_ID, API_HASH
...
@Client.on_message(filters.command("startclone") & filters.user(ADMINS))
async def stop_buttnon(bot, message):
...
async def stop_button(bot, message):
    ...
    async for bot in bots:
        ...
        return
    await msg.edit("Starter all BotBots")
